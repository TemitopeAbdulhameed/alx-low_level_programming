...
/**
 * check_elf - Check if the file is a ELF file.
...
/**
 * print_magic - Print the magic number in ELF header.
 * @e_ident: A pointer to  array containing the ELF magic number.
 *
 * Description: Magic number separate by space
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: A pointer of array contain the ELF class.
 */
void print_data(unsigned char *e_ident)
{
	printf("  Data:                              ");
 ...
 * @e_ident: pointer to  array contain  ELF version.
 */
void print_version(unsigned char *e_ident)
{
	printf("  Version:                           %d",
 ...
 * @e_ident: A pointer to  array contain the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
	printf("  OS/ABI:                            ");
 ...
 * @e_ident:  pointer to  array contain  ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * main - Displays  information contain in 
 *        ELF header in the start of an ELF file.
 * @argc: The number of argument supplied in  program.
 * @argv: the array in pointer to  argument.
 *
 * Return: 0 on success.
 *
